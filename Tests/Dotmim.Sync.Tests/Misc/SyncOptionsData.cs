...
namespace Wormhole.Sync.Tests.Misc
{
    public class SyncOptionsData : IEnumerable<object[]>
    {
        ...
        {
            yield return new object[] { new SyncOptions { BatchSize = 100, TransactionMode = TransactionMode.AllOrNothing, DisableConstraintsOnApplyChanges = true, UseVerboseErrors = true} };
