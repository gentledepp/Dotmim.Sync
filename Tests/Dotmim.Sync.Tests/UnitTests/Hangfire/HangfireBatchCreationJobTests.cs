...
namespace Wormhole.Sync.Tests.UnitTests.Hangfire
{
    ...
    public class HangfireBatchCreationJobTests : IDisposable
    {
        ...
        public async Task ExecuteAsync_WithSuccessfulExecution_ShouldUpdateStatusToCompleted()
        {
            ...
            this.mockExecutor
                .Setup(x => x.ExecuteAsync(jobId, It.IsAny<BatchCreationJobParameters>(), It.IsAny<CancellationToken>()))
        ...
        public async Task ExecuteAsync_WithNonExistentJob_ShouldNotThrow()
        {
            ...
            this.mockExecutor.Verify(
                x => x.ExecuteAsync(It.IsAny<string>(), It.IsAny<BatchCreationJobParameters>(), It.IsAny<CancellationToken>()),
                Times.Never);
        }
        ...
        public async Task ExecuteAsync_ShouldPassCorrectParameters()
        {
            ...
            this.mockExecutor
                .Setup(x => x.ExecuteAsync(jobId, It.IsAny<BatchCreationJobParameters>(), It.IsAny<CancellationToken>()))
                .Callback<string, BatchCreationJobParameters, CancellationToken>((id, p, ct) => capturedParams = p)
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                new HangfireBatchCreationJob(this.jobStore, null, this.mockLogger.Object));
        }
