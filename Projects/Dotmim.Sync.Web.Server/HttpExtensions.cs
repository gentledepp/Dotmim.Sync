...
namespace Dotmim.Sync.Web.Server
{
    internal static class HttpExtensions
    {
        ...
        public static bool TryGetValue(this HttpRequestHeaders n, string key, out string header)
        {
            if (n == null) throw new ArgumentNullException(nameof(n));
            if (n.TryGetValues(key, out var vs))
            {
        ...
        public static bool ContainsKey(this HttpResponseHeaders n, string key)
        {
            if (n == null) throw new ArgumentNullException(nameof(n));
            return n.Contains(key);
        }

        public static void Append(this HttpResponseHeaders n, string key, string value)
        {
            if (n == null) throw new ArgumentNullException(nameof(n));
            n.Add(key, value);
        }
