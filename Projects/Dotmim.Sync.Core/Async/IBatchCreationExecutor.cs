...
{
    /// <summary>
    /// Delegate for batch part progress callbacks.
    /// Called when each batch part is created and ready for download.
    /// </summary>
    /// <param name="batchInfo">Information about current batch storage location etc.</param>
    /// <param name="batchPartInfo">Information about the batch part that was created.</param>
    /// <param name="tablesProcessed">Estimated number of tables processed so far.</param>
    /// <param name="totalTables">Total number of tables being synchronized.</param>
    public delegate Task BatchPartProgressCallback(BatchInfo batchInfo, BatchPartInfo batchPartInfo, int tablesProcessed, int totalTables);
    ...
    public interface IBatchCreationExecutor
    {
        ...
        /// <param name="onBatchPartCreated">Optional callback invoked when each batch part is created.</param>
